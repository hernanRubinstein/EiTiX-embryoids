...
list_of_plates <- c(unique(mat_wt@cell_metadata$Plate), unique(mat_synembs@cell_metadata$Plate))

metadata = metadata[metadata$Plate %in% list_of_plates,]
