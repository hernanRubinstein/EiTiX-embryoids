...
best_reference_metacell_proj = function(mat_query,
                      ref_mc_id,
                      ref_mc2d_id,
                      fn,
                      feat_genes,
...
plot_projected_cells_on_mc2d_background = function(mc2d_id,         
  ...
  mc_x <- mc2d_wt@mc_x[mcs]
    mc_y <- mc2d_wt@mc_y[mcs]
  ...
  points(ref_x, ref_y, pch = 19, col = mc_wt@colors[best_reference_metacell], 
    ...
    points(mc_x, mc_y, pch = 21, bg = mc_wt@colors[mcs], col = "black",
         ylim = ylim, xlim = xlim, cex = cex.points * 5)
    text(mc_x, mc_y, labels = names(mc_y))
...
plot_projected_metacell_on_mc2d_background = function(mc2d_id,         
                                                   best_reference_metacell,
                                                   filename = NULL,        
                                                   atlas_cells_background_color = NULL,
                                                   cex.points = 0.5,
